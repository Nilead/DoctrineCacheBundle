 ...
 */
class RedisWithSerializerDefinition extends CacheDefinition
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        $redisConf = $config['redis_with_serializer'];
    ...
    private function getConnectionReference($name, array $config, ContainerBuilder $container)
    {
        ...
        $connId     = sprintf('doctrine_cache.services.%s_redis_with_serializer.connection', $name);
